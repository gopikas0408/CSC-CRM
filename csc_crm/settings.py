...
SECRET_KEY = 'django-insecure-_r7-ke=d^fsmsl=l1*(0#^2-*nngv*$_jg_)x(r0a*gh^o%dzr'

# For render hosting (temprorily)
...
INSTALLED_APPS = [
    ...
    'csc_crm.apps.admissions.apps.AdmissionsConfig',
    'csc_crm.apps.student_attendance.apps.StudentAttendanceConfig',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'csc_crm' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "csc_crm", "static"),
]
